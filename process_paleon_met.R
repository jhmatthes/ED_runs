...
in.path  <- "/projectnb/cheas/paleon/ED_runs/met_drivers/phase1a_met/bias_corr/"
out.path <- "/projectnb/cheas/paleon/ED_runs/met_drivers/phase1a_met/bias_corr_format/"
